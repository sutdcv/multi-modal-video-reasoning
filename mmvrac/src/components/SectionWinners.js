            ...
            <table className="table table-bordered table-hover">
                <tbody>
                    ...
                    <tr className="d-flex table-info">
                        <th className="col-12 text-center" scope="row">Track 1 (Video Question Answering) Winners</th>
                    </tr>
                    ...
                    <tr className="d-flex table-info">
                        <th className="col-12 text-center" scope="row">Track 2 (Skeleton-based Action Recognition) Winners</th>
                    </tr>
                    ...
                    <tr className="d-flex table-info">
                        <th className="col-12 text-center" scope="row">Track 3 (Fisheye Video-based Action Recognition) Winners</th>
                    </tr>
                    ...
                    <tr className="d-flex table-info">
                        <th className="col-12 text-center" scope="row">Track 4 (Person Re-Identification) Winners</th>
                    </tr>
