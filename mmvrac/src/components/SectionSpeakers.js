    ...
    return (
        <div>
            ...
            <div className="row">
                ...
                <PersonProfile name="Piotr Koniusz" imgSrc="imgs/profiles/pk.jpg" link="http://claret.wikidot.com/" title="" org="MLRG, The Commonwealth Scientific and Industrial Research Organisation (Data61/CSIRO)" dim={135}/>
            </div>
        </div>
    )
}
